...
import javafx.scene.control.Label; // Untuk pesan error
import javafx.scene.layout.VBox;
import moomoo.apps.interfaces.ILaporanKontenController; // Import interface
...
public class LaporanController {
    ...
    private void handleSdmTabAction(ActionEvent event) {
        ...
        switchContent("/moomoo/apps/view/LaporanSdmView.fxml", "sdm");
    }
